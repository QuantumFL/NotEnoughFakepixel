...
import org.ginafro.notenoughfakepixel.events.PacketEvent;
import org.ginafro.notenoughfakepixel.utils.ScoreboardUtils;
import org.ginafro.notenoughfakepixel.utils.Utils;
import org.ginafro.notenoughfakepixel.utils.WaypointUtils;
...
public class Waypoints {
    ...
    public void onWorldRender(RenderWorldLastEvent event) {
        if (!Configuration.dungeonsSecretsWaypoints) return;
    ...
    public void onChat(ClientChatReceivedEvent event) {
        if (!ScoreboardUtils.currentLocation.isDungeon() || !Configuration.dungeonsSecretsWaypoints) return;;
        // Action Bar
        if (event.type == 2) {
    ...
    public void onKey(InputEvent.KeyInputEvent event) {
        if (!ScoreboardUtils.currentLocation.isDungeon() || !Configuration.dungeonsSecretsWaypoints || !sneakToDisable) return;
